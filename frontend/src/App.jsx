              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  ...
                  <div style={{ textAlign: 'left', padding: '6px 0', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '12px' }}>
                    <div style={{ fontSize: '11px', color: '#94a3b8', fontFamily: 'sans-serif' }}>SILVER 925 ITALY GRAM</div>
                    <div style={{ fontSize: '22px', color: '#f8fafc', marginTop: '2px' }}>${Math.round(metals.silver925ItalyGram).toLocaleString()}</div>
                  </div>
